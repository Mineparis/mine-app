    ...
    <div id="modal" className="docs-item element">
      ...
      <div className="docs-desc">
        <p className="lead">
          ...
          the{" "}
          <a href="https://reactstrap.github.io/components/modals/">
      ...
      <div className="mt-5">
        ...
        <Modal isOpen={modal} toggle={onClick} fade>
          <ModalBody className="text-center">
            ...
            <h2 className="modal-title mb-4">Modal title</h2>
          ...
          <ModalFooter className="justify-content-center">
            <Button color="outline-dark" onClick={onClick}>
              Close
            </Button>
            <Button color="dark" onClick={onClick}>
              Save changes
...
const highlightCode = `import { Modal,  ModalBody, ModalFooter, Button } from 'reactstrap'
