    ...
    return (
        <div id="tooltips" className="docs-item element">
            ...
            <div className="mt-5">
                <Card>
                    <CardBody>
                        <Button color="outline-dark" className="mr-1 mb-2" id="Tooltip1">Tooltip on top</Button>
                        <Tooltip
                            placement="top"
                        ...
                        <Button color="outline-dark" className="mr-1 mb-2" id="Tooltip2">Tooltip on right</Button>
                        <Tooltip
                            placement="right"
                        ...
                        <Button color="outline-dark" className="mr-1 mb-2" id="Tooltip3">Tooltip on bottom</Button>
                        <Tooltip
                            placement="bottom"
                        ...
                        <Button color="outline-dark" className="mr-1 mb-2" id="Tooltip4">Tooltip on left</Button>
                        <Tooltip
                            placement="left"
